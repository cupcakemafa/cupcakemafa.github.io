<lucky-word-panel>
        ...
        <div class='modal-dialog lucky-word-modal row' role='document'>
            <div class='modal-content col-xs-12 col-md-8 col-md-offset-2 no-padding'>
                ...
                <div class='modal-body text-center'>
                    <img id='lucky-word-a' class='lucky-word lucky-image' src='https://4.bp.blogspot.com/-FIibBoeaMK4/Vv_kTQ4JYnI/AAAAAAAAB4Q/eHuMFyM-HucKt-vhoYwD3ryFtld2eX6Og/s320/IMG_0222.jpg' alt='イッツニューミー' />
                    ...
                    <div class='text-center row'>
                        ...
                        <div class='col-xs-6 text-left'>
                            <div class='share-this-content'>
                                <span><a id='lucky-word-share-a' class='twitter-share-button' data-size='large' href='' target='_blank'><i class='fa fa-twitter fa-2x'></i></a></span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- modal -->
    <div class='modal fade' id='lucky-word-box-b' tabindex='-1' role='dialog' aria-labelledby='lucky-word-box-b-label'>
        <div class='modal-dialog lucky-word-modal row' role='document'>
            <div class='modal-content col-xs-12 col-md-8 col-md-offset-2 no-padding'>
                <div class='modal-header stripe yellow-light text-center clearfix row no-margin'>
                    <div class='col-xs-12 col-md-8 col-md-offset-2'>
                ...
                <div class='modal-body text-center'>
                    <img id='lucky-word-b' class='lucky-word lucky-image' src='https://2.bp.blogspot.com/-agnHXR8ghtQ/VwUUwHull9I/AAAAAAAAB9Y/zSc7yTHOSPYeg48WtI8DZJ6RWyGMBQ8BQ/s320/IMG_0223.png' alt='そうなんですの?' />
                    <p class='text-muted text-center'>
                        どこかのタイミングで
                        <br /> この言葉をブチ込んでみて!!
                        <br /> きっといい日になるはず!!
                    ...
                    <div class='text-center row'>
                        ...
                        <div class='col-xs-6 text-left'>
                            <div class='share-this-content'>
                                <span><a id='lucky-word-share-b' class='twitter-share-button' data-size='large' href='' target='_blank'><i class='fa fa-twitter fa-2x'></i></a></span>
                            </div>
                        </div>
                    </div>
                </div>
